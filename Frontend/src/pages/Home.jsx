        ...
        {featuredMovie ? (
          <>
            <div className="absolute inset-0">
               ...
               />
               <div className="absolute inset-0 bg-gradient-to-t from-[rgb(var(--background))] via-[rgb(var(--background))/60] to-transparent"></div>
               <div className="absolute inset-0 bg-gradient-to-r from-[rgb(var(--background))] via-transparent to-transparent"></div>
            </div>
            <div className="absolute bottom-0 left-0 w-full p-8 md:p-16">
              <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-6 duration-1000">
                 ...
                 <div className="flex flex-wrap gap-4">
                    <Link to={`/book/${featuredMovie._id}`} className="btn-primary flex items-center gap-2 text-lg px-8 py-3">
                       Book Tickets
                    </Link>
