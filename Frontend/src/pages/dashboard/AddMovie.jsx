        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div>
                ...
                <input type="url" name="posterUrl" placeholder="https://..." required className="input-field" onChange={handleChange} />
             </div>
             <div>
                <label className="block text-gray-400 text-sm font-medium mb-1">Background/Hero Image URL</label>
                <input type="url" name="backgroundUrl" placeholder="https://..." className="input-field" onChange={handleChange} />
             </div>
          </div>
