  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="glass-panel p-8 rounded-xl w-full max-w-md">
        <h2 className="text-3xl font-bold mb-6 text-center text-white">Login to <span className="text-[rgb(var(--primary))]">BookMyTix</span></h2>
        ...
        <p className="mt-4 text-center text-gray-400 text-sm">
          Don't have an account? <Link to="/signup" className="text-[rgb(var(--primary))] hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
