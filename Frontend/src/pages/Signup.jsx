  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] py-10">
      <div className="glass-panel p-8 rounded-xl w-full max-w-md">
        <h2 className="text-3xl font-bold mb-6 text-center text-white">Join <span className="text-[rgb(var(--primary))]">BookMyTix</span></h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
             <label className="block text-gray-400 text-sm font-medium mb-1">I want to...</label>
        ...
        <p className="mt-4 text-center text-gray-400 text-sm">
          Already have an account? <Link to="/login" className="text-[rgb(var(--primary))] hover:underline">Login</Link>
        </p>
      </div>
    </div>
  );
